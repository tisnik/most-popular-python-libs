...
def test_number(value):  #11 (line in Coconut source)
    ...
    if not _coconut_case_match_check_0:  #25 (line in Coconut source)
        ...
        if _coconut_case_match_check_0:  #25 (line in Coconut source)
            ...
            if not _coconut_case_match_check_0:  #25 (line in Coconut source)
                if (_coconut_match_temp_0) and (_coconut.isinstance(_coconut_case_match_to_0, Complex)) and (_coconut_case_match_to_0.real == 0) and (_coconut_case_match_to_0.imag == 0):  #25 (line in Coconut source)
                    _coconut_match_temp_1 = _coconut.len(_coconut_case_match_to_0) <= _coconut.max(0, _coconut.len(_coconut_case_match_to_0.__match_args__)) and _coconut.all(i in _coconut.getattr(_coconut_case_match_to_0, "_coconut_data_defaults", {}) and _coconut_case_match_to_0[i] == _coconut.getattr(_coconut_case_match_to_0, "_coconut_data_defaults", {})[i] for i in _coconut.range(0, _coconut.len(_coconut_case_match_to_0.__match_args__)) if _coconut_case_match_to_0.__match_args__[i] not in ('real', 'imag')) if _coconut.hasattr(_coconut_case_match_to_0, "__match_args__") else _coconut.len(_coconut_case_match_to_0) == 0  # type: ignore  #25 (line in Coconut source)
                    if _coconut_match_temp_1:  #25 (line in Coconut source)
                        _coconut_case_match_check_0 = True  #25 (line in Coconut source)

            if not _coconut_case_match_check_0:  #25 (line in Coconut source)
                if (not _coconut_match_temp_0) and (_coconut.isinstance(_coconut_case_match_to_0, Complex)) and (_coconut_case_match_to_0.real == 0) and (_coconut_case_match_to_0.imag == 0):  #25 (line in Coconut source)
                    _coconut_case_match_check_0 = True  #25 (line in Coconut source)
                if _coconut_case_match_check_0:  #25 (line in Coconut source)
                    _coconut_case_match_check_0 = False  #25 (line in Coconut source)
                    if not _coconut_case_match_check_0:  #25 (line in Coconut source)
    ...
    if not _coconut_case_match_check_0:  #27 (line in Coconut source)
        _coconut_match_temp_3 = _coconut.getattr(Complex, "_coconut_is_data", False) or _coconut.isinstance(Complex, _coconut.tuple) and _coconut.all(_coconut.getattr(_coconut_x, "_coconut_is_data", False) for _coconut_x in Complex)  # type: ignore  #27 (line in Coconut source)
        ...
        if _coconut_case_match_check_0:  #27 (line in Coconut source)
            ...
            if not _coconut_case_match_check_0:  #27 (line in Coconut source)
                if (_coconut_match_temp_3) and (_coconut.isinstance(_coconut_case_match_to_0, Complex)):  #27 (line in Coconut source)
                    ...
                    if _coconut_match_temp_4:  #27 (line in Coconut source)
                        _coconut_case_match_check_0 = True  #27 (line in Coconut source)

            if not _coconut_case_match_check_0:  #27 (line in Coconut source)
                if (not _coconut_match_temp_3) and (_coconut.isinstance(_coconut_case_match_to_0, Complex)):  #27 (line in Coconut source)
                    _coconut_case_match_check_0 = True  #27 (line in Coconut source)
                if _coconut_case_match_check_0:  #27 (line in Coconut source)
                    _coconut_case_match_check_0 = False  #27 (line in Coconut source)
                    if not _coconut_case_match_check_0:  #27 (line in Coconut source)
                    ...
                    if not _coconut_case_match_check_0:  #27 (line in Coconut source)
                        if not _coconut.type(_coconut_case_match_to_0) in _coconut_self_match_types:  #27 (line in Coconut source)
                            _coconut_match_temp_5 = _coconut.getattr(Complex, '__match_args__', ())  # type: _coconut.typing.Any  # type: ignore  #27 (line in Coconut source)
                            if not _coconut.isinstance(_coconut_match_temp_5, _coconut.tuple):  #27 (line in Coconut source)
                                raise _coconut.TypeError("Complex.__match_args__ must be a tuple")  #27 (line in Coconut source)
                            if _coconut.len(_coconut_match_temp_5) < 0:  #27 (line in Coconut source)
                                raise _coconut.TypeError("too many positional args in class match (pattern requires 0; 'Complex' only supports %s)" % (_coconut.len(_coconut_match_temp_5),))  #27 (line in Coconut source)
                            _coconut_case_match_check_0 = True  #27 (line in Coconut source)
