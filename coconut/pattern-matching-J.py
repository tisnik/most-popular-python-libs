...
def test_number(value):  #11 (line in Coconut source)
    ...
    if not _coconut_case_match_check_0:  #25 (line in Coconut source)
        ...
        if _coconut_case_match_check_0:  #25 (line in Coconut source)
            ...
            if not _coconut_case_match_check_0:  #25 (line in Coconut source)
                if (_coconut_match_temp_0) and (_coconut.isinstance(_coconut_case_match_to_0, Complex)):  #25 (line in Coconut source)
                    _coconut_match_temp_1 = _coconut.getattr(_coconut_case_match_to_0, 'real', _coconut_sentinel)  #25 (line in Coconut source)
                    _coconut_match_temp_2 = _coconut.getattr(_coconut_case_match_to_0, 'imag', _coconut_sentinel)  #25 (line in Coconut source)
                    _coconut_match_temp_3 = _coconut.len(_coconut_case_match_to_0) <= _coconut.max(0, _coconut.len(_coconut_case_match_to_0.__match_args__)) and _coconut.all(i in _coconut.getattr(_coconut_case_match_to_0, "_coconut_data_defaults", {}) and _coconut_case_match_to_0[i] == _coconut.getattr(_coconut_case_match_to_0, "_coconut_data_defaults", {})[i] for i in _coconut.range(0, _coconut.len(_coconut_case_match_to_0.__match_args__)) if _coconut_case_match_to_0.__match_args__[i] not in ('real', 'imag')) if _coconut.hasattr(_coconut_case_match_to_0, "__match_args__") else _coconut.len(_coconut_case_match_to_0) == 0  # type: ignore  #25 (line in Coconut source)
                    if (_coconut_match_temp_1 is not _coconut_sentinel) and (_coconut_match_temp_1 == 0) and (_coconut_match_temp_2 is not _coconut_sentinel) and (_coconut_match_temp_2 == 0) and (_coconut_match_temp_3):  #25 (line in Coconut source)
                        _coconut_case_match_check_0 = True  #25 (line in Coconut source)

            if not _coconut_case_match_check_0:  #25 (line in Coconut source)
                if (not _coconut_match_temp_0) and (_coconut.isinstance(_coconut_case_match_to_0, Complex)):  #25 (line in Coconut source)
                    _coconut_match_temp_5 = _coconut.getattr(_coconut_case_match_to_0, 'real', _coconut_sentinel)  #25 (line in Coconut source)
                    _coconut_match_temp_6 = _coconut.getattr(_coconut_case_match_to_0, 'imag', _coconut_sentinel)  #25 (line in Coconut source)
                    if (_coconut_match_temp_5 is not _coconut_sentinel) and (_coconut_match_temp_5 == 0) and (_coconut_match_temp_6 is not _coconut_sentinel) and (_coconut_match_temp_6 == 0):  #25 (line in Coconut source)
                        _coconut_case_match_check_0 = True  #25 (line in Coconut source)
                if _coconut_case_match_check_0:  #25 (line in Coconut source)
                    _coconut_case_match_check_0 = False  #25 (line in Coconut source)
                    if not _coconut_case_match_check_0:  #25 (line in Coconut source)
                    ...
                    if not _coconut_case_match_check_0:  #25 (line in Coconut source)
                        if not _coconut.type(_coconut_case_match_to_0) in _coconut_self_match_types:  #25 (line in Coconut source)
                            _coconut_match_temp_4 = _coconut.getattr(Complex, '__match_args__', ())  # type: _coconut.typing.Any  # type: ignore  #25 (line in Coconut source)
                            if not _coconut.isinstance(_coconut_match_temp_4, _coconut.tuple):  #25 (line in Coconut source)
                                raise _coconut.TypeError("Complex.__match_args__ must be a tuple")  #25 (line in Coconut source)
                            if _coconut.len(_coconut_match_temp_4) < 0:  #25 (line in Coconut source)
                                raise _coconut.TypeError("too many positional args in class match (pattern requires 0; 'Complex' only supports %s)" % (_coconut.len(_coconut_match_temp_4),))  #25 (line in Coconut source)
                            _coconut_case_match_check_0 = True  #25 (line in Coconut source)
        ...
        if _coconut_case_match_check_0:  #25 (line in Coconut source)
            print("Zero complex represented as object")  #26 (line in Coconut source)
    if not _coconut_case_match_check_0:  #27 (line in Coconut source)
        _coconut_match_temp_7 = _coconut.getattr(Complex, "_coconut_is_data", False) or _coconut.isinstance(Complex, _coconut.tuple) and _coconut.all(_coconut.getattr(_coconut_x, "_coconut_is_data", False) for _coconut_x in Complex)  # type: ignore  #27 (line in Coconut source)
        _coconut_case_match_check_0 = True  #27 (line in Coconut source)
        if _coconut_case_match_check_0:  #27 (line in Coconut source)
            _coconut_case_match_check_0 = False  #27 (line in Coconut source)
            if not _coconut_case_match_check_0:  #27 (line in Coconut source)
                if (_coconut_match_temp_7) and (_coconut.isinstance(_coconut_case_match_to_0, Complex)):  #27 (line in Coconut source)
                    _coconut_match_temp_8 = _coconut.len(_coconut_case_match_to_0) <= _coconut.max(0, _coconut.len(_coconut_case_match_to_0.__match_args__)) and _coconut.all(i in _coconut.getattr(_coconut_case_match_to_0, "_coconut_data_defaults", {}) and _coconut_case_match_to_0[i] == _coconut.getattr(_coconut_case_match_to_0, "_coconut_data_defaults", {})[i] for i in _coconut.range(0, _coconut.len(_coconut_case_match_to_0.__match_args__))) if _coconut.hasattr(_coconut_case_match_to_0, "__match_args__") else _coconut.len(_coconut_case_match_to_0) == 0  # type: ignore  #27 (line in Coconut source)
                    if _coconut_match_temp_8:  #27 (line in Coconut source)
                        _coconut_case_match_check_0 = True  #27 (line in Coconut source)

            if not _coconut_case_match_check_0:  #27 (line in Coconut source)
                if (not _coconut_match_temp_7) and (_coconut.isinstance(_coconut_case_match_to_0, Complex)):  #27 (line in Coconut source)
                    _coconut_case_match_check_0 = True  #27 (line in Coconut source)
                if _coconut_case_match_check_0:  #27 (line in Coconut source)
                    _coconut_case_match_check_0 = False  #27 (line in Coconut source)
                    if not _coconut_case_match_check_0:  #27 (line in Coconut source)
                        if _coconut.type(_coconut_case_match_to_0) in _coconut_self_match_types:  #27 (line in Coconut source)
                            _coconut_case_match_check_0 = True  #27 (line in Coconut source)

                    if not _coconut_case_match_check_0:  #27 (line in Coconut source)
                        if not _coconut.type(_coconut_case_match_to_0) in _coconut_self_match_types:  #27 (line in Coconut source)
                            _coconut_match_temp_9 = _coconut.getattr(Complex, '__match_args__', ())  # type: _coconut.typing.Any  # type: ignore  #27 (line in Coconut source)
                            if not _coconut.isinstance(_coconut_match_temp_9, _coconut.tuple):  #27 (line in Coconut source)
                                raise _coconut.TypeError("Complex.__match_args__ must be a tuple")  #27 (line in Coconut source)
                            if _coconut.len(_coconut_match_temp_9) < 0:  #27 (line in Coconut source)
                                raise _coconut.TypeError("too many positional args in class match (pattern requires 0; 'Complex' only supports %s)" % (_coconut.len(_coconut_match_temp_9),))  #27 (line in Coconut source)
                            _coconut_case_match_check_0 = True  #27 (line in Coconut source)
        ...
        if _coconut_case_match_check_0:  #27 (line in Coconut source)
            print(value)  #28 (line in Coconut source)
    if not _coconut_case_match_check_0:  #29 (line in Coconut source)
        _coconut_case_match_check_0 = True  #29 (line in Coconut source)
        if _coconut_case_match_check_0:  #29 (line in Coconut source)
            raise ValueError("Not a complex number")  #30 (line in Coconut source)



test_number((0, 0))  #33 (line in Coconut source)
test_number((1, 0))  #34 (line in Coconut source)
test_number((-1, 0))  #35 (line in Coconut source)
test_number((0, 1))  #36 (line in Coconut source)
test_number((0, -1))  #37 (line in Coconut source)
test_number((1, 1))  #38 (line in Coconut source)

test_number(Complex(0, 0))  #40 (line in Coconut source)
test_number(Complex(1, 0))  #41 (line in Coconut source)
test_number(Complex(-1, 0))  #42 (line in Coconut source)
test_number(Complex(0, 1))  #43 (line in Coconut source)
test_number(Complex(0, -1))  #44 (line in Coconut source)
test_number(Complex(1, 1))  #45 (line in Coconut source)
