...
colormap=["#a00000", "#a0a000",                                   # native
          "#00a000", "#00b030", "#00c060", "#00d090", "#00e0a0",  # Python interpreters
          "#ff0000", "#ff8000",                                   # mypyc
          "#0000ff", "#0060ff", "#00c0ff",                        # Numba
          "#ff8080",                                              # Nuitka
          "#808080", "#a0a0a0", "#c0c0c0"                         # Cython
     ]
...
#results[0:5].plot(kind='bar', stacked=False, width=0.9, title="Startup time")
results[11:][["python 3 8", "python 3 9" , "python 3 10", "python 3 11", "python 3 12"]].plot(
        kind="bar", title="Python interpreters only", color=colormap[2:])
plt.tight_layout()
...
compiled = results[11:][["native", "native optim", "mypyc no type hints", "mypyc with type hints",
                    "nuitka", "cython basic", "cython types", "cython optim"]]
compiled.plot(
        kind="bar", color=colormap, title="Compiled code only")
plt.tight_layout()
