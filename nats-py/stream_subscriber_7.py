...
async def main():
    ...
    try:
        sub = await jet_stream.subscribe(SUBJECT_NAME, stream="users-add-operations", cb=on_message, manual_ack=True, config=configuration)
        while True:
