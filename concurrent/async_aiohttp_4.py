...
async def main():
    ...
    await asyncio.gather(
        ...
        asyncio.create_task(download(4, queue, results)),
        asyncio.create_task(download(5, queue, results)),
        asyncio.create_task(download(6, queue, results)),
        asyncio.create_task(download(7, queue, results)),
        asyncio.create_task(download(8, queue, results)),
        asyncio.create_task(download(9, queue, results)),
        asyncio.create_task(download(10, queue, results)),
    )
