...
optimizer7 = optim.SGD(nn7.parameters(), lr=0.5)
...
for epoch in range(num_epochs):
    ...
    for X, y in train_dataloader:
        ...
        # výpočet účelové funkce
        loss = loss_fn(pred, y.unsqueeze(-1))
        loss_values_7.append(loss.item())
        loss.backward()
        optimizer7.step()
        print(".", end="")
    print()
...
plt.plot(step, np.array(loss_values_7), label="nn7")
